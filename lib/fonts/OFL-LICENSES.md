# Bundled fonts — licenses & credits

These fonts ship inside PocketOffice (in `lib/fonts/`) so documents look the
same on every PC, even with no internet and no fonts installed. They are
loaded offline via `css/fonts.css` — no network requests at runtime.

| Family | Style(s) | File(s) | License | Designer / Foundry |
|--------|----------|---------|---------|--------------------|
| Inter | variable 100–900 + italic | `inter-var.woff2`, `inter-var-italic.woff2` | SIL OFL 1.1 | Rasmus Andersson |
...
Copyright (c) Rasmus Andersson (Inter), Cyreal (Lora), JetBrains (JetBrains Mono).
...
distributed and/or sold with any software, provided that each copy
